...
class ViewController: UIViewController {
    ...
    private let indicators: [LEActivityIndicatorView] = [
        LEActivityIndicatorView(style: .defaultStyle,
                                size: .medium,
                                colorSet: LEActivityColorSet(mainColor: UIColor(red: 0.405,
                                                                                green: 0.722,
                                                                                blue: 0.9,
                                                                                alpha: 1),
                                                             secondMainColor: UIColor(),
                                                             complementaryColor: nil)),
        LEActivityIndicatorView(style: .spinner,
                                size: .medium,
                                colorSet: LEActivityColorSet(mainColor: .white,
                                                             secondMainColor: UIColor(red: 0.875,
                                                                                      green: 0.12,
                                                                                      blue: 0.392,
                                                                                      alpha: 1),
                                                             complementaryColor: nil)),
        LEActivityIndicatorView(style: .gradient,
                                size: .medium,
                                colorSet: LEActivityColorSet(mainColor: UIColor(red: 0.827,
                                                                                green: 1,
                                                                                blue: 0.337,
                                                                                alpha: 1),
                                                             secondMainColor: UIColor(red: 0.827,
                                                                                      green: 1,
                                                                                      blue: 0.337,
                                                                                      alpha: 1).withAlphaComponent(0),
                                                             complementaryColor: nil)),
        LEActivityIndicatorView(style: .wave,
                                size: .medium,
                                colorSet: LEActivityColorSet(mainColor: UIColor(red: 0.110,
                                                                                green: 0.110,
                                                                                blue: 0.110,
                                                                                alpha: 1),
                                                             secondMainColor: UIColor(red: 0.298,
                                                                                      green: 0.459,
                                                                                      blue: 0.949,
                                                                                      alpha: 1),
                                                             complementaryColor: nil)),
        LEActivityIndicatorView(style: .bouble,
                                size: .medium,
                                colorSet: LEActivityColorSet(mainColor: UIColor(red: 0.137,
                                                                                green: 0.762,
                                                                                blue: 0.162,
                                                                                alpha: 1),
                                                             secondMainColor: UIColor(),
                                                             complementaryColor: nil)),
        LEActivityIndicatorView(style: .line,
                                size: .medium,
                                colorSet: LEActivityColorSet(mainColor: .white,
                                                             secondMainColor: UIColor(red: 0.243,
                                                                                      green: 0.606,
                                                                                      blue: 0.942,
                                                                                      alpha: 1),
                                                             complementaryColor: nil)),
        LEActivityIndicatorView(style: .cube,
                                size: .medium,
                                colorSet: LEActivityColorSet(mainColor: UIColor(red: 0.942,
                                                                                green: 0.868,
                                                                                blue: 0.204,
                                                                                alpha: 1),
                                                             secondMainColor: UIColor(red: 0.721,
                                                                                      green: 0.666,
                                                                                      blue: 0.174,
                                                                                      alpha: 1),
                                                             complementaryColor: UIColor(red: 0.475,
                                                                                         green: 0.439,
                                                                                         blue: 0.111,
                                                                                         alpha: 1))),
        LEActivityIndicatorView(style: .walking,
                                size: .medium,
                                colorSet: LEActivityColorSet(mainColor: UIColor(red: 1,
                                                                                green: 0.718,
                                                                                blue: 0.082,
                                                                                alpha: 1),
                                                             secondMainColor: UIColor(red: 0.869,
                                                                                      green: 0.282,
                                                                                      blue: 0.35,
                                                                                      alpha: 1),
                                                             complementaryColor: UIColor(red: 0.476,
                                                                                         green: 0.193,
                                                                                         blue: 0.495,
                                                                                         alpha: 1))),
    ]
